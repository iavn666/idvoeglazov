...
public class qq {
        ...
        1.	Что такое виртуальная машина?
            Java Virtual Machine  Java — основная часть исполняющей системы Java,
        ...
        Development Kit (JDK) полноценный набор библиотек и инструментов для для создания,
        компилирования и дебага программ.
        Java Runtime Environment. это среда выполнения для языка Java.
        Java ByteCode compilir (javac) компилятор
        Java Virtual Machine

        4.	Для чего используется JDK?
        Набор инструментов для начала программирования

        5.	Для чего используется JRE?
        JRE(Java runtime environment) - обеспечивает выполнение Java-программы на                   различных платформах

        6.	Для чего используется VM?
        Среда исполнение скомпилированного кода
        ...
        Классы помещяющие примитивные типы в объект. Т.е. представление
        примитивного типа, как объект.
        ...
        -создаем файл с расширением java. Пишем туда код. Запускаем javac (компилятор) получаем байт код. Далее этот байт код запускает виртуальная машина. Расширение *.class
        ...
        Short-circuit укороченный тоже что и в низу
        ...
        Цикл используется многократного повтарения чего-либо, если мы точно знаем кол-во требуемых повторения.
        ...
        Нужен для многократного повторения, когда мы не знаем требуемого кол-ва итераций, а дожидаемся не определенного условия.
        ...
        тело цикло выполнится хотя бы один раз.

        26.	Что такое массив?
        Массив — это структура данных, в которой хранятся величины одинакового типа. Массив - это именнованное множество переменных, объектов одного типа.
